...
const TeamCreatePage = () => {
  ...
  const handleSubmit = () => {
    ...
    setTimeout(() => {
      ...
      Alert.alert(
        "Team Submitted",
        "Your team has been submitted for approval. You will be notified once it is approved.",
        [{ text: "OK", onPress: () => router.push("/team") }],
      );
    }, 1500);
  };
  ...
  return (
    <View className="flex-1 bg-white">
      ...
      <ScrollView className="flex-1 p-4">
        ...
        <View className="mb-4 p-4 bg-blue-50 rounded-md border border-blue-100">
          <Text className="text-blue-800 text-sm">
            Your team will be reviewed by an administrator before being
      ...
      <View className="p-4 border-t border-gray-200 bg-white">
        ...
        >
          {isSubmitting ? (
            ...
            <Text className="text-white font-bold">Submit for Approval</Text>
          )}
        </TouchableOpacity>
      </View>
    </View>
